...
const NftCard = (props: {
  ...
  const placeholderImage = 'https://carlogino.com/assets/nft-placeholder.png'; // Replace with your actual placeholder image path
      ...
      <div className="h-full w-full">
        <div className="relative w-full">
          <Image
            width={300}
            height={300}
            className="mb-3 h-full w-full rounded-xl 3xl:h-full 3xl:w-full object-cover"
