...
function SidebarHashpredict(props: { variant?: string; [x: string]: any }) {
          ...
          <div className="flex h-full flex-col justify-between">
            <div>
              ...
              <div className={`ml-[52px] mt-[44px] flex items-center `}>
                ...
                >
                  Hashpredict <span className="font-medium">PRO</span>
                </div>
                <div
                  className={`mr-1 mt-1 h-2.5 font-poppins text-[26px] font-bold uppercase text-navy-700 dark:text-white ${
                    mini === false
...
export default SidebarHashpredict;
